...
- [Blame (`git blame`)](../blame/) -- identificar linea por linea quien hizo cada cambio.
- [Bisect (`git bisect`)](../bisect/) -- busqueda binaria para encontrar el commit que introdujo un bug.
- [Diff avanzado (`git diff`)](../diff-avanzado/) -- comparar cambios entre commits, ramas o el staging.

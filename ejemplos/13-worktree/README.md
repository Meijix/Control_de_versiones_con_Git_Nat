...
- [Stash (`git stash`)](../01-stash/) — alternativa para guardar trabajo temporal sin crear worktrees.
- [Reset (`git reset`)](../06-reset/) — deshacer cambios en el historial o el staging area.

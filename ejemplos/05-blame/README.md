...
- [Bisect](../11-bisect/README.md) — encontrar el commit que introdujo un error.
- [Log avanzado](../03-log-avanzado/README.md) — filtrar y buscar en el historial.
- [Diff avanzado](../02-diff-avanzado/README.md) — comparar ramas y commits.

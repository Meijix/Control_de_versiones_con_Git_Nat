...
- [`merge-conflictos`](../04-merge-conflictos/) — Profundiza en la detección y resolución de conflictos de merge.
- [`rebase-interactivo`](../10-rebase-interactivo/) — Limpia el historial de la feature antes de fusionar (alternativa a merge).
- [`tag`](../12-tag/) — Etiquetas ligeras vs anotadas, convenciones de versionado y gestión de releases.
- [`stash`](../01-stash/) — Guardar trabajo temporal cuando necesitas cambiar de rama sin commitear.

...
- [Hooks de Git: `pre-commit`](../hooks-pre-commit/) — automatizar validaciones locales antes de cada commit.
- [GitHub Actions](../github-actions/) — validaciones en CI/CD que complementan la configuración local.
